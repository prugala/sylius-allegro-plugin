...
final class GreetingController extends Controller
{
    ...
    {
        return $this->render('@PrugalaSyliusAllegroPlugin/static_greeting.html.twig', ['greeting' => $this->getGreeting($name)]);
    }
    ...
    {
        return $this->render('@PrugalaSyliusAllegroPlugin/dynamic_greeting.html.twig', ['greeting' => $this->getGreeting($name)]);
    }
